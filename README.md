...
**FinLake** — Large-scale financial data pipeline and agentic trading platform using Databricks, Spark, Delta Lake, FastAPI, and LangGraph.

**TraceQL** — CLI tool that builds compact repo graphs to help AI coding agents understand large codebases with fewer tokens.

**OptiCode** — macOS clipboard and secrets manager with global shortcuts, persistent slots, and a background menu-bar style agent.
...
- Website: [aryanpatel.dev](https://aryanpatel.dev)
